...
const Signup = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to TNB Drive. You can now access your files.",
      });
      navigate("/dashboard");
    }, 1500);
  };
  ...
  const passwordStrengthColor = passwordStrength === "Strong" ? "text-green-600" : passwordStrength === "Medium" ? "text-yellow-600" : "text-red-600";
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="tnb-shadow-lg border-0">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Get started with TNB Drive and secure your files in the cloud
            </CardDescription>
          </CardHeader>
